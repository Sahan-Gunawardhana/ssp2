<x-guest-layout>
    <div class="max-w-md p-6 mx-auto mt-10 bg-white rounded-lg shadow-lg">
        <h2 class="mb-4 text-3xl font-bold text-center text-green-500">Join the Pawsome Family</h2>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="flex items-center justify-center mt-4 tex">
                <x-button class="justify-center w-full py-2 mb-4 text-center text-white bg-green-500 rounded-lg hover:bg-green-600">
                    {{ __('Register') }}
                </x-button>
            </div>
